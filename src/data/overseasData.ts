...
export const OVERSEAS_COUNTRIES: OverseasCountry[] = [
  ...
  },
  {
    ...
    region: "Middle East / Gulf",
    flag: "🇰🇼",
    image: "https://images.unsplash.com/photo-1578895210405-907db486c111?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    region: "Eastern Europe",
    flag: "🇲🇩",
    image: "https://images.unsplash.com/photo-1572979241482-a39da979177a?auto=format&fit=crop&w=800&q=80",
